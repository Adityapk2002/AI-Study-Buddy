...
export default function LandingPage(){
  ...
  const tabs = [
    { id: 'ask', label: 'Ask Anything', icon: MessageCircle },
    ...
    return(
        ...
        <div className='max-w-4xl mx-auto'>
          <div className='text-center mb-8'>
            <h1 className='text-5xl font-extrabold bg-gradient-to-b from-red-400 to-black/60 bg-clip-text text-transparent'>AI Study Buddy</h1>
            <p className="mt-4 text-2xl text-gray-600">Ask questions, summarize notes, and generate quizzes with AI</p>
        </div>
            ...
            {tabs.map((tab) => {
              return(
                <button
                  ...
                  <tab.icon className="inline-block mr-2" />{tab.label}
                </button>
              )
            })}
          </div>
